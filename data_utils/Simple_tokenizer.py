...
def default_bpe():
    import sys
    sys.path.append('..')
    return os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "pretrained/english_simpleTokenizer/bpe_simple_vocab_16e6.txt")
...
class SimpleTokenizer(object):
    ...
    def tokenize(self, texts, context_length = 256, truncate_text = True):
